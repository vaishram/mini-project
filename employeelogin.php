...
if(isset($_POST['submit']))
{
 ...
 $link=mysqli_connect("localhost","root","hellodb123","project") or die($link); 
...
<?php
	...
	{
		$funame = $_POST['funame'];
		$conn=mysqli_connect("localhost","root","hellodb123","project") or die("connection failed".mysqli_connect_error());
